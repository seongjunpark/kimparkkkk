...
public class CommentDialog extends Dialog implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		com_ls.addHeaderView(comment_header());
	...
	public RelativeLayout my_header = null;
	
	private RelativeLayout comment_header() {
		mInflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		my_header = (RelativeLayout) mInflater.inflate(R.layout.comment_header,
				null);
		
		return my_header;
	}
	
	public static RelativeLayout my_footer = null;
	
	private RelativeLayout my_footer() {
		mInflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		my_footer = (RelativeLayout) mInflater.inflate(R.layout.comment_footer,
				null);

		ImageButton btn_ok = (ImageButton)my_footer.findViewById(R.id.btn_okk);
	...
	public void setMessage() {
		...
		gcmMessage = new Message.Builder()
				...
				.addData("ticker", GCMname + "�섏씠 湲�쓣 �④꼈�듬땲��")
