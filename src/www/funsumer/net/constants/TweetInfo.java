...
public class TweetInfo {
	...
	private String Article_Scrap_Num;
	...
	public void setAuthorpic(String Authorpic) {
		this.Authorpic = "http://funsumer.net/" + Authorpic + "50";
	}
	...
	public String getArticle_Scrap_Num() {
		return Article_Scrap_Num;
	}

	public void setArticle_Scrap_Num(String Article_Scrap_Num) {
		this.Article_Scrap_Num = Article_Scrap_Num;
	}
