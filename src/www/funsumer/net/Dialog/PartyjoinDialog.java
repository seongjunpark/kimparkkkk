package www.funsumer.net.Dialog;
...
import www.funsumer.net.CustomDialogListener;
import www.funsumer.net.MainActivity;
import www.funsumer.net.PartyActivity;
import www.funsumer.net.R;
import www.funsumer.net.R.id;
import www.funsumer.net.R.layout;
...
public class PartyjoinDialog extends Dialog implements View.OnClickListener {
	...
	public PartyjoinDialog(Context context, int type, CustomDialogListener listener) {
		super(context);
		mContext = context;
		mType = type;
		mListener = listener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		v = vi.inflate(R.layout.dialog_partyjoin, null);
	...
	public void onClick(View v) {
		...
		case R.id.btn_ok: {
			...
			try {
				...
				params1.add(new BasicNameValuePair("pid", PartyActivity.partyid));
			...
			PartyActivity.btn_join.setVisibility(View.INVISIBLE);
			PartyActivity.btn_invite.setVisibility(View.VISIBLE);
