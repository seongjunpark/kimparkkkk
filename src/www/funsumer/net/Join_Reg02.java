...
public class Join_Reg02 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Button bt_nexter = (Button) findViewById(R.id.bt_nexter);
...
//								"Welcome to FUNSUMER!! ", "Success", false);
		...
		bt_nexter.setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN)
					bt_nexter.setBackgroundResource(R.drawable.btn_write_selected);
					bt_nexter.setPadding(15, 3, 15, 3);
				if (event.getAction() == MotionEvent.ACTION_UP) {
					bt_nexter.setBackgroundResource(R.drawable.btn_cancle3);
				}
				return false;
			}
		});
...
//				"market://details?id=www.funsumer.net",
//				"<펀슈머>우리끼리 이빨터는 모임SNS!!", getPackageName(), getPackageManager()
