...
public class UpdateDialog extends Dialog implements View.OnClickListener {
	...
	public UpdateDialog(Context context, int type, CustomDialogListener listener) {
		super(context);
		mContext = context;
		mType = type;
		mListener = listener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		v = vi.inflate(R.layout.update_dialog, null);
	...
	public void onClick(View v) {
		...
		case R.id.btn_ok: {
			...
			marketLaunch.setData(Uri.parse("http://play.google.com/store/apps/details?id=www.funsumer.net&feature=search_result#?t=W251bGwsMSwyLDEsInd3dy5mdW5zdW1lci5uZXQiXQ..")); 
			v.getContext().startActivity(marketLaunch);
