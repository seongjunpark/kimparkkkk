...
public class Join_Reg01 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * 
		 * // �좎룞��list.add("野껋��쀯옙占쎈린�댐옙); list.add("占쎌뮄�낉옙占쎈린�댐옙); list.add("占쎌뮇�깍옙占쎈린�댐옙);
		 * list.add("占쎄퀣苑�옙占쎈린�댐옙);
		 * 
		...
		btn_next02.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (email1.getText().toString().equals("")) {
					...
					new CustomDialog(Join_Reg01.this,
							CustomDialog.TYPE_BASIC_OK, null, "중복된 이메일 입니다.")
							.show();
					return;
					...
					new CustomDialog(Join_Reg01.this,
							CustomDialog.TYPE_BASIC_OK, null, "학교를 입력해 주세요.")
							.show();
					return;
				} else {
					//for funsumer server
...
//						Toast.makeText(getApplicationContext(), "펀슈머에 오신 것을 환영합니다.",
